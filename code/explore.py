...
output = pd.read_csv('output2.csv').drop(columns=['Unnamed: 0'])
...
axs[0,0].legend(output_pivot.index[0:3])
...
axs[0,1].plot(output_pivot.iloc[4])
axs[0,1].plot(output_pivot.iloc[5])
axs[0,1].plot(output_pivot.iloc[6])
axs[0,1].legend(output_pivot.index[3:7])
axs[0,1].set_xlabel('x_bar_1')
axs[0,1].set_title("error vs. x_bar_1 for different p_1")

axs[1,0].plot(output_pivot.iloc[7])
axs[1,0].plot(output_pivot.iloc[8])
axs[1,0].legend(output_pivot.index[7:10])
axs[1,0].set_xlabel('x_bar_1')
axs[1,0].set_title("error vs. x_bar_1 for different p_1")

axs[1,1].plot(output_pivot.iloc[9])
axs[1,1].plot(output_pivot.iloc[10])
axs[1,1].legend(output_pivot.index[9:11])
