...
\subsection*{4. Generalization of case 1 and 2}
...
wom^2
(a*(x*(x * b + (1-x) * c))^2 - 2*c*(x)^2*((1-x) * a + x * c)*(x * b + (1-x)*c) + b*(x*((1-x) * a + x * c))^2) /((1-x)^2*a + 2*x*(1-x)*c + x^2*b)^2
= ((a b - c^2) x^2)/(a + 2 (-a + c) x + (a + b - 2 c) x^2)

men^2
(b*((1-x)*((1-x) * a + x * c))^2 - 2*c*(1-x)^2*((1-x) * a + x * c)*(x * b + (1-x)*c) + a*((1-x)*(x * b + (1-x) * c))^2) /((1-x)^2*a + 2*x*(1-x)*c + x^2*b)^2
=((a b - c^2) (x-1)^2)/(a + 2 (-a + c) x + (a + b - 2 c) x^2)

(1-p)* ((a b - c^2) x^2)/(a + 2 (-a + c) x + (a + b - 2 c) x^2) + p*((a b - c^2) (x-1)^2)/(a + 2 (-a + c) x + (a + b - 2 c) x^2)


(a b - c^2)*((1-p)* x^2 + p*(x-1)^2) /(a + 2 (-a + c) x + (a + b - 2 c) x^2)

d/dx (1-p)* ((a b - c^2) x^2)/(a + 2 (-a + c) x + (a + b - 2 c) x^2) + p*((a b - c^2) (x-1)^2)/(a + 2 (-a + c) x + (a + b - 2 c) x^2)


gives us 
(  a (p - 1) + b p - 2 c p \pm sqrt(a^2 (p - 1)^2 + 2 a b p (p - 1) + p (b^2 p - 4 c^2 (p - 1))))/(2 (a (p - 1) + b p - 2 c p + c))
