...
% \begin{align*}
% 	W_{women}^2 &= (C_{men} \bar{x}))^2\Var(\gamma_1)\\
% 				& -  2 C_{women} C_{men}\Cov(\gamma_0, \gamma_1)  \\
% 				& + (\bar{x} C_{women})^2\Var(\gamma_0) \\
% \end{align*} 
...
% b*((1-x)*((1-x) * a)/((1-x)^2*a + x^2*b))^2 +
% a*((1-x)*(x * b)/((1-x)^2*a + x^2*b))^2
